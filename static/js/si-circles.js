...
var fields=
	[
	  ...
	  {radius: 0.2 * radius, label:"Emotion", tier:1},
	  {radius: 0.3 * radius, label:"Cognition", tier:1},
...
field.on("click", function(event,d){
	...
	location.href = '/tiers?tier='+activeTier+'&theme=concept';
	...
	_j(".tier-icon").removeClass("d-none")
	_j(".tier-icon").removeClass(removeCls).addClass(addCls)

	_j("#tier_text h3, #tier_text p").addClass("d-none")

	_j("#tier_text :eq("+h_child+")").removeClass("d-none")
	_j("#tier_text :eq("+p_child+")").removeClass("d-none")

	// people icons
	_j(".tier-graphics").addClass("tier-graphics-"+activeTier)
	_j(".learn-more").removeClass("d-none")
...
field.on("mouseover", function(event,d){
	...
	_j(".instructions").addClass("d-none")
	_j(".tiers-container").removeClass("d-none")
	...
	// people icons
	_j(".tier-graphics").removeClass(["tier-graphics-1","tier-graphics-2","tier-graphics-3"])
	_j(".tier-graphics").addClass("tier-graphics-"+currTier)
	...
	_j(".instructions").removeClass("d-none")
	_j(".tiers-container").addClass("d-none")
